...
def re_cities_distances():  # 返回两两城市的距离
    cities_distances1 = {}
    cities_distances2 = {}
    cities = re_list(fo)
    i = 0
...
def re_cities_name():  # 返回所有城市名组成的列表
    cities = re_list(fo)
    cities_name = []
...
def special_city_list(city):  # 返回特定城市
    city_list1 = []
